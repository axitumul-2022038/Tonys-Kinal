...
public class Empleados {
    ...
    public Empleados(int codigoEmpleado, int numeroEmpleado, String apellidosEmpleado, String nombresEmpleado, String direccionEmpleado, String telefonoEmpleado, String gradoCocinero, int codigoTipoEmpleado) {
